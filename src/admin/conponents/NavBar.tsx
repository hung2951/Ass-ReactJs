            ...
            <div className="py-4 text-gray-500 dark:text-gray-400">
                ...
                <ul className="pt-10">
                    <li className="relative px-6">
                        <NavLink to="/admin/" className={({ isActive }) => (isActive ? "text-red-700 no-underline" : "no-underline text-black")}>
                ...
                <ul>
                    <li className="relative px-6 py-3">
                        <NavLink to="/admin/category" className={({ isActive }) => (isActive ? "text-red-700 no-underline" : "no-underline text-black")}>
                            <div className="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" >
                                <svg className="w-5 h-5" aria-hidden="true" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <li className="relative px-6 py-3">
                        <NavLink to="/admin/product" className={({ isActive }) => (isActive ? "text-red-700 no-underline" : "no-underline text-black")}>
                            <div className="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <svg className="w-5 h-5" aria-hidden="true" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <li className="relative px-6 py-3">
                        <NavLink to="/admin/user" className={({ isActive }) => (isActive ? "text-red-700 no-underline" : "no-underline text-black")}>
                            <div className="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <svg className="w-5 h-5" aria-hidden="true" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <li className="relative px-6 py-3">
                        <NavLink to="/admin/slide-show" className={({ isActive }) => (isActive ? "text-red-700 no-underline" : "no-underline text-black")}>
                            <div className="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <svg className="w-5 h-5" aria-hidden="true" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} viewBox="0 0 24 24" stroke="currentColor">
